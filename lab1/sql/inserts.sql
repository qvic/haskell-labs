...
INSERT INTO public.article (id, name, annotation, author_id) VALUES (1, 'name 1', 'ann 1', 1);
INSERT INTO public.article (id, name, annotation, author_id) VALUES (2, 'name 2', 'ann 2', 2);

INSERT INTO public.article_feedback (id, article_id, author_id, text) VALUES (2, 2, 2, 'Very bad');
INSERT INTO public.article_feedback (id, article_id, author_id, text) VALUES (1, 1, 1, 'Very nice');
